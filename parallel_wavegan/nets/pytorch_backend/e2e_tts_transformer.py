...
from parallel_wavegan.nets.pytorch_backend.e2e_tts_tacotron2 import GuidedAttentionLoss
from parallel_wavegan.nets.pytorch_backend.e2e_tts_tacotron2 import (
    Tacotron2Loss as TransformerLoss,  # noqa: H301
)
from parallel_wavegan.nets.pytorch_backend.nets_utils import make_non_pad_mask
from parallel_wavegan.nets.pytorch_backend.tacotron2.decoder import Postnet
from parallel_wavegan.nets.pytorch_backend.tacotron2.decoder import Prenet as DecoderPrenet
from parallel_wavegan.nets.pytorch_backend.tacotron2.encoder import Encoder as EncoderPrenet
...
from parallel_wavegan.nets.pytorch_backend.transformer.embedding import ScaledPositionalEncoding
...
from parallel_wavegan.nets.tts_interface import TTSInterface
...
try:
    ...
    class TTSPlot(PlotAttentionReport):
        ...
        def plotfn(
            ...
            from parallel_wavegan.nets.pytorch_backend.transformer.plot import (
