...
from parallel_wavegan.nets.pytorch_backend.fastspeech.duration_calculator import (
    DurationCalculator,  # noqa: H301
)
from parallel_wavegan.nets.pytorch_backend.fastspeech.duration_predictor import DurationPredictor
from parallel_wavegan.nets.pytorch_backend.fastspeech.duration_predictor import (
    DurationPredictorLoss,  # noqa: H301
)
from parallel_wavegan.nets.pytorch_backend.fastspeech.length_regulator import LengthRegulator
...
class FeedForwardTransformer(TTSInterface, torch.nn.Module):
    ...
    def attention_plot_class(self):
        ...
        from parallel_wavegan.nets.pytorch_backend.e2e_tts_transformer import TTSPlot
