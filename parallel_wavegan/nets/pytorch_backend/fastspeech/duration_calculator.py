...
from parallel_wavegan.nets.pytorch_backend.e2e_tts_tacotron2 import Tacotron2
from parallel_wavegan.nets.pytorch_backend.e2e_tts_transformer import Transformer
