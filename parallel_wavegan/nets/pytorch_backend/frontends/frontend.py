...
from parallel_wavegan.nets.pytorch_backend.frontends.dnn_beamformer import DNN_Beamformer
from parallel_wavegan.nets.pytorch_backend.frontends.dnn_wpe import DNN_WPE
