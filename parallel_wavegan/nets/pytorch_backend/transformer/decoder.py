...
from parallel_wavegan.nets.pytorch_backend.transformer.decoder_layer import DecoderLayer
...
from parallel_wavegan.nets.scorer_interface import BatchScorerInterface
