...
from parallel_wavegan.nets.pytorch_backend.e2e_asr_transformer import subsequent_mask
...
from parallel_wavegan.nets.pytorch_backend.e2e_tts_transformer import (
